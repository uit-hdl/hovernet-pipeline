...
if __name__ == '__main__':
    ...
    config_dict = {
        ...
        {   
            ...
            'step_size': [int(STEP_SIZE[f'{args.profile}']), int(STEP_SIZE[f'{args.profile}'])],
            'win_size': [int(WIN_SIZE[f'{args.profile}']), int(WIN_SIZE[f'{args.profile}'])],
            ...
            'skip_types': args.skip_types.split(',') if (args.skip_types is not None) else args.skip_types
        }
    }
